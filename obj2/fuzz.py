...
class Fuzzer:
    ...
    def generate_test_case(self, length):
        ...
        """
        random_string = ''.join(random.choices(string.ascii_letters + string.digits + string.punctuation + string.punctuation, k=length))
    ...
    def run(self):
        ...
        while time.time() - self.start_time < self.timeout:
            ...
            if test_length < 10 and self.runs % 10000 == 0:
                test_length += 1
